               ...
               <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 flex flex-col md:col-span-2">
                   ...
                   <div className="flex flex-col md:flex-row items-end gap-4 bg-amber-50 p-4 rounded-lg border border-amber-100">
                       ...
                       <button 
                        ...
                        className="bg-amber-600 text-white px-4 py-2 rounded-lg font-bold hover:bg-amber-700 shadow-sm disabled:opacity-50 w-full md:w-auto"
                       >
                           Salvar
                       </button>
                   </div>
       ...
       {activeTab === 'roles' && (
           <div className="space-y-6 animate-fadeIn">
               ...
               <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
                   ...
                   <div className="flex flex-col md:flex-row gap-4 mb-8 bg-gray-50 p-4 rounded-xl border border-gray-200 items-start">
                       ...
                       <div className="mt-auto pt-5">
                            <button 
                                disabled={!hasPermission('settings:manage_roles_list')}
                                onClick={addRole} 
                                className="bg-indigo-600 text-white px-6 py-2 rounded-lg font-bold hover:bg-indigo-700 shadow-sm whitespace-nowrap h-[38px] disabled:opacity-50 disabled:cursor-not-allowed w-full md:w-auto"
                            >
                                Adicionar
                            </button>
                       </div>
                   ...
                   <div className="overflow-hidden border border-gray-200 rounded-lg shadow-sm overflow-x-auto">
               ...
               <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
                   ...
                   <div className="flex flex-col md:flex-row gap-4 mb-8 p-4 bg-gray-50 rounded-xl border border-gray-200 items-end">
                       ...
                       <button 
                        ...
                        className="bg-indigo-600 text-white px-6 py-2 rounded-lg font-bold hover:bg-indigo-700 shadow-sm h-[38px] disabled:opacity-50 disabled:cursor-not-allowed w-full md:w-auto"
                       >
                           Adicionar
                       </button>
                   </div>
